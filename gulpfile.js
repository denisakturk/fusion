...
//         'src/libs/slick/slick.min.js' // Берем Magnific Popup
//         ])
...
gulp.task('watch', function() {
    ...
    // gulp.watch(['src/common.js', 'src/libs/**/*.js'], gulp.parallel('scripts')); // Наблюдение за главным JS файлом и за библиотеками
});

gulp.task('default', gulp.parallel('pug', 'sass', 'lint-css', 'browser-sync', 'watch')); // + css-libs scripts
